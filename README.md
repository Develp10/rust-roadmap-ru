...
Полный курс по языку программирования Rust на русском языке: от первой строчки кода до асинхронности, embedded и WebAssembly. Каждый урок состоит из теории, практики и теста с ответами. https://t.me/rust_code — основной канал телеграм по Rust на русском, больше уроков и практики.
